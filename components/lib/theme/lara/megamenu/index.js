...
.p-megamenu {
    ...
    color: var(--p-horizontal-menu-text-color, var(--p-dark-pink-0, var(--p-pink-700)));
...
.p-megamenu.p-megamenu-vertical {
    min-width: var(--p-menu-width, 12.5rem);
    padding: var(--p-vertical-menu-padding, ar(.25rem 0, var(.5rem 0)));
}
...
.p-megamenu.p-megamenu-horizontal .p-megamenu-root-list > .p-menuitem > .p-menuitem-content .p-menuitem-link {
    padding: var(--p-horizontal-menu-root-menuitem-padding, .75rem 1.25rem);
    user-select: var(--p-menu-user-select, none);
}
